       ...
       <button
        ...
        <div className="flex items-center gap-4">
          ...
          <button className="text-[#EF7722] p-1.5 rounded-lg bg-white bg-opacity-10 cursor-default">
            ...
            <button onClick={() => setShowLogoutModal(true)} className="text-gray-400 hover:text-red-400 transition-colors p-1.5 rounded-lg hover:bg-red-400 hover:bg-opacity-10">            <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center z-50">
          <div className="bg-white rounded-2xl p-6 w-full max-w-sm shadow-2xl border border-gray-100">
            ...
            <div className="flex gap-3">
              ...
              <button onClick={() => { localStorage.removeItem('token'); localStorage.removeItem('user'); navigate('/login'); }} className="flex-1 px-4 py-2.5 bg-[#EF4444] text-white rounded-xl text-sm font-bold hover:bg-red-600 transition-all shadow-md shadow-red-100 hover:-translate-y-0.5">
                Log out
              </button>
            </div>
          </div>
