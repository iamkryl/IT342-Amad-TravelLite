...
function PlanTripModal({
  ...
  return (
    <div className="fixed inset-0 bg-black/60 backdrop-blur-sm flex items-center justify-center z-50 p-4">
      <div
        className="rounded-2xl w-full max-w-2xl max-h-[90vh] overflow-y-auto overflow-x-visible"
        style={{
          background: '#1a2332',
          border: '1px solid rgba(255,255,255,0.08)',
          scrollbarWidth: 'thin',
      ...
      >
        ...
        {/* Body */}
        <div className="px-6 pt-6 pb-2" style={{ overflow: 'visible' }}>
          ...
          <div className="flex flex-col gap-[5px]">
            ...
            <div className="relative">
              ...
              <input type="date" value={startDate} onChange={(e) => setStartDate(e.target.value)} min={new Date().toISOString().split('T')[0]} className={iconInput} style={{ colorScheme: 'dark' }} />
            </div>
          </div>
          ...
          <div className="flex flex-col gap-[5px]">
            ...
            <div className="relative">
              <span className="absolute left-3 top-1/2 -translate-y-1/2 text-[#6b7280] pointer-events-none">...</span>
              <input type="date" value={endDate} onChange={(e) => setEndDate(e.target.value)} min={startDate || new Date().toISOString().split('T')[0]} className={iconInput} style={{ colorScheme: 'dark' }} />
            </div>
          </div>
        </div>
          ...
          <div key={index} className="grid grid-cols-2 gap-[10px] mb-[10px] relative">
